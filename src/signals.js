...
export const [alternative] = createSignal([
{
...
export const [rock] = createSignal([
{
    title: "Bayern Rock",
...
export const [electronic] = createSignal([
{
...
export const [misc] = createSignal([
    {
      "src": "https://cp1.sednastream.com:8014/stream",
      "title": "ClubFM Albania",
